...
export const uk: TranslationMap = {
  ...
  login: {
    ...
    failure: {
      ...
      docsSupport: "Зв’язатися з AlpenData",
      employee: {
        title: "Увійдіть через свою компанію",
        summary:
          "Ця AgentBox використовує корпоративну ідентичність. Відкрийте помічника з корпоративного порталу або зверніться до AlpenData, якщо сеанс закінчився.",
        stepCompany: "Увійдіть знову через постачальника ідентичності компанії.",
        stepPortal: "Відкрийте AgentBox за корпоративним посиланням від адміністратора.",
        stepSupport: "Якщо підключитися не вдається, зверніться до AlpenData.",
        network: {
          title: "Не вдалося зв’язатися з AgentBox",
          summary:
            "Помічник недоступний із цього браузера. Спробуйте знову з корпоративного порталу, а якщо збій триває — зверніться до AlpenData.",
          stepPortal: "Перезавантажте AgentBox з корпоративного порталу або закладки.",
          stepSupport: "Зверніться до AlpenData, якщо перебій триває.",
        },
      },
      authRequired: {
